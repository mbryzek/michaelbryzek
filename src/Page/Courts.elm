...
import Browser
import Html exposing (Html, div, footer, h1, header, img, p, source, text, video)
...
sectionMay2025 =
    monthSection "May 2025"
        "First we need drainage"
